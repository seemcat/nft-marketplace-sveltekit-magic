<script>
	...
	import logo from './magic-logo.svg';
...
<header>
	<div class="corner">
		<a href="https://magic.link/">
			<img src={logo} alt="Magic" />
		</a>
	</div>
	...
	<nav>
		...
		<ul>
			{#if user}
				...
				<li class:active={$page.path === '/mint'}>
					<a sveltekit:prefetch href="/mint">Mint</a>
				</li>
...
<style>
	...
	nav {
		display: flex;
		justify-content: center;
		--background: rgba(165, 153, 221, 0.7);
	}
